...
class OSCAMRImageHelper: OSCAMRImageHelperInterface {
    ...
    override fun compressImage(activity: Activity?, uri: Uri?, bitmap: Bitmap?, compressFormat: CompressFormat, mQuality: Int, onError : (OSCAMRError) -> Unit){
     ...
     * @param bitmap
     */
    override fun processPicture(bitmap: Bitmap?, encodingType: Int, mQuality: Int, onSuccess : (String) -> Unit, onError : (OSCAMRError) -> Unit) {
    ...
    override fun bitmapToBase64(result: Bitmap?, resolution: Int, quality: Int, onSuccess : (String) -> Unit, onError : (OSCAMRError) -> Unit) {
